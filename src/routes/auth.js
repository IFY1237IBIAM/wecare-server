...
router.post("/signup", async (req, res) => {
  try {
    ...
    // Extract fields
    const { email, password, displayName, name } = value;

    // Support BOTH name + displayName
    const finalDisplayName = displayName || name || undefined;
    ...
    await sendMail({
      ...
      html: `
        ...
        <a href="${verifyUrl}" style="padding:10px 20px; background-color:#1976D2; color:#fff; text-decoration:none; border-radius:5px;">
          Verify Email
        </a>
